...
*/
	 ...
	 */
	$config['site_title']		   = "www.colegiodelartemayordelaseda.es";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@colegiodelartemayordelaseda.es";
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('first_name', 'last_name', 'telefono');
	 ...
	 **/
	$config['error_start_delimiter'] = '<label class="error">';
	
	/**
	 * Error End Delimiter
	 **/
	$config['error_end_delimiter'] = '</label>';
